...
const FILES=['./','./index.html','./style.css','./app.js','./backup-dialog.js','./employee-dialog.js','./state-manager.js','./model.js','./stores.js','./crypto-backup.js','./birthdays.js','./holidays.js','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png'];
